...
MOCK_TICKETS: list[Ticket] = [
    ...
    Ticket(
        title="举报托管中心无证经营并提供餐饮服务",
        content="提交人反映，北京市北京市朝阳区某托管中心现有从业人员3名，其中1名厨师，在未取得营业证照和食品经营许可证的情况下，对外招收学生提供托管服务和餐饮服务。2025年下半年，该托管中心按600元/人/月的标准收取托管费用，检查时共有在托学生18名。提交人要求市场监管部门依法核查其无证无照经营和食品经营许可情况，并依法查处。",
        ...
        incident_address="北京市北京市朝阳区某托管中心",
        appeal_purpose="要求依法核查并查处无证无照经营和未取得食品经营许可行为",
    ),
    Ticket(
        title="举报企业登记时提交虚假住所材料",
        content="提交人反映，某公司在企业登记平台申请登记营业执照时，申请人和签字人承诺填报的信息及提交的材料真实、准确、有效、完整，并承担相应法律责任。但该公司实际未与出租方签订房屋租赁合同，却上传伪造的不动产权证书，于2024年7月4日办理了营业执照。提交人要求市场监管部门依法核查该公司涉嫌提交虚假材料取得市场主体登记的行为，并依法处理。",
        ...
        incident_address="北京市北京市朝阳区某企业登记住所",
